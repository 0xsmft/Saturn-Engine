...
namespace CrashCatch {
    ...
    inline LONG WINAPI UnhandledExceptionHandler(EXCEPTION_POINTERS* ep) {
        ...
        const std::wstring dumpFileStr = dumpPath.wstring();
        ...
        HANDLE hFile = CreateFileW( dumpFileStr.c_str(), GENERIC_WRITE, 0, nullptr, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, nullptr);
