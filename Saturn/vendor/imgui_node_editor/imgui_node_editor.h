...
namespace ax {
	namespace NodeEditor {
		...
		IMGUI_NODE_EDITOR_API void SelectPin( PinId pinID, bool append = false );

		IMGUI_NODE_EDITOR_API void SuspendUserInput();
		IMGUI_NODE_EDITOR_API void ResumeUserInput();
