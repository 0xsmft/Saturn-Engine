...
static void initDistance(double &distance) {
    distance = SignedDistance::SAT_MODIFIED_SD_INFINITE.distance;
}

static void initDistance(MultiDistance &distance) {
    distance.r = SignedDistance::SAT_MODIFIED_SD_INFINITE.distance;
    distance.g = SignedDistance::SAT_MODIFIED_SD_INFINITE.distance;
    distance.b = SignedDistance::SAT_MODIFIED_SD_INFINITE.distance;
}
